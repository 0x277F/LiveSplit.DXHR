...
namespace LiveSplit.DXHR
{
    class GameMemory
    {
        ...
        public event EventHandler OnKeyPadClose; // Called after the index has been incremented.
        ...
        public String[] KeyCodes = // All key codes that are used in DX:HR any% speedruns.
        {
          "0451",
          "1337",
          "9212",
            ...
            while (!_cancelSource.IsCancellationRequested)
            {
                try
                {
                    ...
                    while (!game.HasExited)
                    {
                        ...
                        if (isDirectorsCut) // Unfortunately I can't find the addresses on normal edition because I don't own it. ._.
                        {
                            bool isMonOpen;
                            ...
                            if (prevKeypad && prevMonOpen && !isMonOpen)
                            {
                                ...
                                {
                                   this.OnKeyPadClose(this, EventArgs.Empty);
                                }
                            }
