...
{
    public class DXHRFactory : IComponentFactory
    {
        private DXHRComponent _instance;
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            if (_instance != null && !_instance.Disposed)
            {
                ...
                MessageBox.Show(
                    "LiveSplit.DXHR is already loaded in the " +
            ...
            return (_instance = new DXHRComponent(state, createAsLayoutComponent));
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/drtchops/LiveSplit.DXHR/master/"; }
        }
        ...
        {
            get { return this.UpdateURL + "Components/update.LiveSplit.DXHR.xml"; }
        }
    }
